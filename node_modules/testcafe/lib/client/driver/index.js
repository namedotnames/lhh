					...
					"command-executors": {
						...
						"client-functions": {
							...
							"replicator.js": function (exports, module, require) {
								...
								exports.__esModule = true;
								exports.ClientFunctionNodeTransform = exports.SelectorNodeTransform = exports.SelectorElementActionTransform = exports.FunctionTransform = undefined;
								...
								var SelectorElementActionTransform = exports.SelectorElementActionTransform = function () {
								    function SelectorElementActionTransform() {
								        _classCallCheck(this, SelectorElementActionTransform);

								        this.type = 'Node';
								    }

								    SelectorElementActionTransform.prototype.shouldTransform = function shouldTransform(type, val) {
								        return val instanceof Node;
								    };

								    SelectorElementActionTransform.prototype.toSerializable = function toSerializable(node) {
								        return new _nodeSnapshots.ElementActionSnapshot(node);
								    };
							...
							"selector-executor": {
								...
								"node-snapshots.js": function (exports, module, require) {
									...
									exports.__esModule = true;
									exports.ElementSnapshot = exports.ElementActionSnapshot = exports.NodeSnapshot = undefined;
									...
									var BaseSnapshot = function () {
									    function BaseSnapshot() {
									        _classCallCheck(this, BaseSnapshot);
									    }

									    BaseSnapshot.prototype._initializeProperties = function _initializeProperties(node, properties, initializers) {
									...
									var NodeSnapshot = exports.NodeSnapshot = function (_BaseSnapshot) {
									    _inherits(NodeSnapshot, _BaseSnapshot);

									    function NodeSnapshot(node) {
									        _classCallCheck(this, NodeSnapshot);

									        var _this = _possibleConstructorReturn(this, _BaseSnapshot.call(this));

									        _this._initializeProperties(node, _snapshotProperties.NODE_SNAPSHOT_PROPERTIES, nodeSnapshotPropertyInitializers);
									        return _this;
									    }
									...
									var ElementActionSnapshot = exports.ElementActionSnapshot = function (_BaseSnapshot2) {
									    _inherits(ElementActionSnapshot, _BaseSnapshot2);

									    function ElementActionSnapshot(element) {
									        _classCallCheck(this, ElementActionSnapshot);

									        var _this2 = _possibleConstructorReturn(this, _BaseSnapshot2.call(this, element));

									        _this2._initializeProperties(element, _snapshotProperties.ELEMENT_ACTION_SNAPSHOT_PROPERTIES, elementSnapshotPropertyInitializers);
									        return _this2;
									    }
									...
									var ElementSnapshot = exports.ElementSnapshot = function (_NodeSnapshot) {
									    ...
									    function ElementSnapshot(element) {
									        ...
									        var _this3 = _possibleConstructorReturn(this, _NodeSnapshot.call(this, element));

									        _this3._initializeProperties(element, _snapshotProperties.ELEMENT_SNAPSHOT_PROPERTIES, elementSnapshotPropertyInitializers);
									        return _this3;
									    }
						...
						"execute-action.js": function (exports, module, require) {
							...
							var _replicator = require('./client-functions/replicator');
							        ...
							        return this._ensureCommandElements().then(function () {
							            ...
							            if (automation.TARGET_ELEMENT_FOUND_EVENT) {
							                automation.on(automation.TARGET_ELEMENT_FOUND_EVENT, function (e) {
							                    _this2.targetElement = e.element;
							    ...
							    ActionExecutor.prototype.execute = function execute() {
							        ...
							        var completionPromise = new _hammerhead.Promise(function (resolve) {
							            ...
							            actionPromise.then(function () {
							                ...
							                var elements = [].concat(_this4.elements);

							                if (_this4.targetElement) elements[0] = _this4.targetElement;

							                status.result = (0, _replicator.createReplicator)(new _replicator.SelectorElementActionTransform()).encode(elements);

							                resolve(new _status2.default(status));
							            }).catch(function (err) {
						...
						var Driver = function (_serviceUtils$EventEm) {
						    ...
						    Driver.prototype._handleSetAsMasterMessage = function _handleSetAsMasterMessage(msg, wnd) {
						        ...
						        Promise.resolve().then(function () {
						            ...
						            _this5.setAsMasterInProgress = false;
						        }).catch(function () {
						    ...
						    Driver.prototype._abortSwitchingToChildWindowIfItClosed = function _abortSwitchingToChildWindowIfItClosed() {
						        if (!this.activeChildWindowDriverLink.driverWindow.closed) return;

						        _testcafeCore.arrayUtils.remove(this.childWindowDriverLinks, this.activeChildWindowDriverLink);
						        this.activeChildWindowDriverLink = null;

						        throw new _testRun.ChildWindowClosedBeforeSwitchingError();
						    };
						    ...
						    Driver.prototype._switchToChildWindow = function _switchToChildWindow(selector) {
						        ...
						        return (0, _executeChildWindowDriverLinkSelector2.default)(selector, this.childWindowDriverLinks).then(function (childWindowDriverLink) {
						            ...
						            _this13._abortSwitchingToChildWindowIfItClosed();
						            ...
						            if (err instanceof _testRun.ChildWindowClosedBeforeSwitchingError) {
			...
			"client-functions": {
				"selectors": {
					"snapshot-properties.js": function (exports, module, require) {
						...
						var ELEMENT_ACTION_SNAPSHOT_PROPERTIES = exports.ELEMENT_ACTION_SNAPSHOT_PROPERTIES = ['tagName', 'attributes'];
			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						var ChildWindowClosedBeforeSwitchingError = exports.ChildWindowClosedBeforeSwitchingError = function (_TestRunErrorBase55) {
						    _inherits(ChildWindowClosedBeforeSwitchingError, _TestRunErrorBase55);

						    function ChildWindowClosedBeforeSwitchingError() {
						        _classCallCheck(this, ChildWindowClosedBeforeSwitchingError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase55.call(this, _types.TEST_RUN_ERRORS.childWindowClosedBeforeSwitchingError));
						    }
