							...
							var VisibleElementAutomation = function (_serviceUtils$EventEm) {
							    ...
							    VisibleElementAutomation.prototype._scrollToElement = function _scrollToElement() {
							        ...
							        return scrollAutomation.run().then(function (scrollWasPerformed) {
							            ...
							            var elementUnderCursorContainsTarget = !!currentElement && _testcafeCore.domUtils.contains(_this3.element, currentElement);
							    ...
							    VisibleElementAutomation.prototype._ensureElement = function _ensureElement(useStrictElementCheck, skipCheckAfterMoving) {
							        ...
							        return this._wrapAction(function () {
							            ...
							            _this5.emit(_this5.TARGET_ELEMENT_FOUND_EVENT, { element: state.element });
					...
					"utils": {
						...
						"dom.js": function (exports, module, require) {
							...
							function contains(element, target) {
							    ...
							    if (element.contains) return element.contains(target);

							    return !!findParent(target, true, function (node) {
							        return node === element;
							    });
							}
						},
